...
glmB_poisson_JAGS<-function(formul,data=NULL,Niter=105000,Nburnin=5000,Nthin=5,Prior=NULL,Seuilmonit=NULL,Graph=TRUE){
...
predictions		<-exp(design_mat_burtee%*%coefficients_moy)
...
##################################################################################
cat("---------------------------");cat("\n")
cat("REGRESSION POISSON BAYESIENNE");cat("\n")
cat("---------------------------");cat("\n");cat("\n")
cat("---------------------------");cat("\n")
titre<-paste("---	Graphique: Residus --------")
cat(titre);cat("\n")
cat("---------------------------");cat("\n")
